...
export const Profile = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await axiosClient.put(`/password_update/${user.id}/`, {
    ...
    return (
        <Box mt="5px" >
            ...
            <GradientText gradient="#ffd140, #2b6cb0">
            Modifier profile</GradientText>
            <Flex
                align={'center'}
                justify={'center'}
                                ...
                                <FormControl id="img" >
                                    <Center>
                                        <label htmlFor="imageInput">
                                            ...
                                            />
                                            <Avatar boxSize={['100px', '150px', '200px', '250px']} src={user.imageUrl || avatarUrl}>
                                                <AvatarBadge
